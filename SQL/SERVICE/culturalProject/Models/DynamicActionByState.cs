...
namespace culturalProject.Models
{
    ...
    public class DynamicActionByStateBL
    {
        ...
        public DataTable postDynamicNewProposalByAdmin(DynamicActionByState objDynamicActionByState)
        {
            SqlConnection conn = new SqlConnection(strConn);
            conn.Open();
            SqlCommand cmd = new SqlCommand("Mst_GetDynamicNewApprovalsByAdmin", conn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable postDynamicReqToPutOnHoldByAdmin(DynamicActionByState objDynamicActionByState)
        {
            SqlConnection conn = new SqlConnection(strConn);
            conn.Open();
            SqlCommand cmd = new SqlCommand("Mst_postDynamicReqToPutOnHoldByState", conn);
