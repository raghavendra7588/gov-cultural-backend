...
namespace culturalProject.Models
{
    public class ProposalForm
    {
        ...
        public string FilePathDob { get; set; }
        public string FilePathMaharashtraResidence { get; set; }

        public string FilePathAnnualIncome { get; set; }
        public string FileIllHandicaped { get; set; }

        public string FilePathGovtRecognisition { get; set; }
        public string FilePathCulturalMinistryCertification { get; set; }

        public string FilePathSponseredPrograms { get; set; }
        public string FilePathCollectorNominatedProgram { get; set; }

        public string FilePathIndividualInstitution { get; set; }
        public string FilePathNotarisedCertificateOfConfirmation { get; set; }

        public string FilePathGovtBeneficiaryBenefit { get; set; }
        public string FilePathmanualForm { get; set; }


    }

    public class ProposalFormBL
    {
        ...
        public string PostGovPersonalDetails(ProposalForm objGov_PersonalDetails)
        {
      ...
      /*  public string updateAddressToDb(ProposalForm objGov_PersonalDetails, int id)
        {
            SqlConnection conn = new SqlConnection(strConn);
            conn.Open();
